...
* [`src/my_app/`](src/my_app/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/my_app/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `my-app` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/my_app/config.cljs) defaults to `true` in
